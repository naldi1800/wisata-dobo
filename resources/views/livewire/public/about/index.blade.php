        ...
        <div class="space-y-8">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg p-8 border border-zinc-200 dark:border-zinc-700">
                ...
                <p class="text-zinc-600 dark:text-zinc-400">
                    Dengan sistem ini, wisatawan dapat dengan mudah menemukan informasi lengkap tentang destinasi wisata, akomodasi hotel, dan tempat kuliner cafe yang tersedia di Kabupaten Kepulauan Aru,以及 mendapatkan rekomendasi yang objektif berdasarkan penilaian kualitas.
                </p>
            </div>
